...
namespace dbCommon
{
   namespace adapters
   {
      DECLARE_ADAPTER_IMPLEMENTATION(Plugin,
         ...
         ((AutoStart)(bool)(true))
         ((Category)(dbCommon::entities::EPluginCategory)(dbCommon::entities::EPluginCategory::kUser)(std::string))
      )             ;
      ...
      DECLARE_ADAPTER_IMPLEMENTATION(Configuration,
         ...
         ((SecurityAccess)(dbCommon::entities::ESecurityAccess)(dbCommon::entities::ESecurityAccess::kNone)(std::string))
      ...
      DECLARE_ADAPTER_IMPLEMENTATION(PluginEventLogger,
         ...
         ((EventType)(dbCommon::entities::EEventType)(dbCommon::entities::EEventType::kUnload)(std::string))
         ((Message)(std::string)(""))
      )             ;
      ...
      DECLARE_ADAPTER_IMPLEMENTATION(EventLogger,
         ...
         ((Code)(dbCommon::entities::ESystemEventCode)(dbCommon::entities::ESystemEventCode::kDefaultCode)(std::string))
         ((Who)(std::string)(""))
         ((What)(std::string)(""))
      )           ;
      ...
      DECLARE_ADAPTER_IMPLEMENTATION(AcquisitionSummary,
         ((Type)(dbCommon::entities::EAcquisitionSummaryType)(dbCommon::entities::EAcquisitionSummaryType::kHour)(std::string))
         ((Date)(boost::posix_time::ptime)(shared::currentTime::Provider().now()))
         ((KeywordId)(int)(0))
         ((Avg)(std::string)(""))
         ((Min)(std::string)(""))
      ...
      DECLARE_ADAPTER_IMPLEMENTATION(Rule,
         ...
         ((Configuration)(shared::CDataContainer)(shared::CDataContainer()))
         ((AutoStart)(bool)(true))
         ((State)(dbCommon::entities::ERuleState)(dbCommon::entities::ERuleState::kStopped)(std::string))
