...
namespace dbCommon
{
   ...
   Plugin,
      ...
      ((Category)(dbCommon::entities::EPluginCategory)(dbCommon::entities::EPluginCategory::kSystem)("category"))
      );
   ...
   Configuration,
      ...
      ((SecurityAccess)(dbCommon::entities::ESecurityAccess)(dbCommon::entities::ESecurityAccess::kNone)("securityAccess"))
   ...
   PluginEventLogger,
      ...
      ((EventType)(dbCommon::entities::EEventType)(dbCommon::entities::EEventType::kUnload)("eventType"))
   ...
   EventLogger,
      ...
      ((Code)(dbCommon::entities::ESystemEventCode)(dbCommon::entities::ESystemEventCode::kDefaultCode)("code"))
      ((Who)(std::string)("")("who"))
   ...
   DECLARE_ENTITY_CLASS_IMPLEMENTATION(
   AcquisitionSummary,
      ((Type)(dbCommon::entities::EAcquisitionSummaryType)(dbCommon::entities::EAcquisitionSummaryType::kHour)("type"))
      ((Date)(boost::posix_time::ptime)(shared::currentTime::Provider().now())("date"))
      ((KeywordId)(int)(0)("keywordId"))
      ((Avg)(std::string)("")("avg"))
      ((Min)(std::string)("")("min"))
   ...
   Rule,
      ...
      ((Configuration)(shared::CDataContainer)(shared::CDataContainer())("configuration"))
      ((AutoStart)(bool)(true)("autoStart"))
      ((State)(dbCommon::entities::ERuleState)(dbCommon::entities::ERuleState::kStopped)("state"))
	...
	DECLARE_ENTITY_CLASS_IMPLEMENTATION(
      ...
      ((Fields)(std::vector< boost::shared_ptr<dbCommon::entities::CRecipientField> >)(std::vector< boost::shared_ptr<dbCommon::entities::CRecipientField> >())("fields"))
	);
