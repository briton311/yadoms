...
namespace dbCommon
{
   namespace entities
   {
      ...
      DECLARE_ENTITY_CLASS_HEADER(Plugin,
         ...
         ((AutoStart)(bool))
         ((Category)(dbCommon::entities::EPluginCategory))
      )
      ...
      DECLARE_ENTITY_CLASS_HEADER(Configuration,
         ...
         ((SecurityAccess)(dbCommon::entities::ESecurityAccess))
      ...
      DECLARE_ENTITY_CLASS_HEADER(PluginEventLogger,
         ...
         ((EventType)(dbCommon::entities::EEventType))
         ((Message)(std::string))
      )
      ...
      DECLARE_ENTITY_CLASS_HEADER(EventLogger,
         ...
         ((Code)(dbCommon::entities::ESystemEventCode))
         ((Who)(std::string))
         ((What)(std::string))
      )
      ...
      DECLARE_ENTITY_CLASS_HEADER(AcquisitionSummary,
         ((Type)(dbCommon::entities::EAcquisitionSummaryType))
         ((Date)(boost::posix_time::ptime))
         ((KeywordId)(int))
         ((Avg)(std::string))
         ((Min)(std::string))
      ...
      DECLARE_ENTITY_CLASS_HEADER(Rule,
         ...
         ((Configuration)(shared::CDataContainer))
         ((AutoStart)(bool))
         ((State)(dbCommon::entities::ERuleState))
      ...
      DECLARE_ENTITY_CLASS_HEADER(Recipient,
         ...
         ((LastName)(std::string))
         ((Fields)(std::vector< boost::shared_ptr<dbCommon::entities::CRecipientField> >))
      )
   } //namespace entities
} //namespace dbCommon
