...
#include "Query.h"
#include "adapters/IResultAdapter.h"
...
namespace dbCommon
{
   ...
   public:
      ...
      //--------------------------------------------------------------
      virtual void queryEntities(adapters::IResultAdapter* pAdapter,
                                 const CQuery& querytoExecute) = 0;
      ...
      //--------------------------------------------------------------  
      virtual int queryStatement(const CQuery& querytoExecute,
      ...
      //--------------------------------------------------------------  
      virtual int queryCount(const CQuery& querytoExecute) = 0;
      ...
      //--------------------------------------------------------------  
      virtual QueryRow querySingleLine(const CQuery& querytoExecute) = 0;
      ...
      //--------------------------------------------------------------  
      virtual QueryResults query(const CQuery& querytoExecute) = 0;
      ...
      //--------------------------------------------------------------
      virtual bool checkTableExists(const CDatabaseTable& tableName) = 0;
      ...
      //--------------------------------------------------------------
      virtual bool dropTableIfExists(const CDatabaseTable& tableName) = 0;
      ...
      /// \return	      true if table exists
      //--------------------------------------------------------------
      virtual bool createTableIfNotExists(const CDatabaseTable& tableName,
      ...
      //--------------------------------------------------------------
      virtual bool addTableColumn(const CDatabaseTable& tableName,
      ...
      //--------------------------------------------------------------
      virtual void createIndex(const CDatabaseTable& tableName,
