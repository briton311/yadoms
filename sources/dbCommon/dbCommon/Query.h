...
#define CQUERY_OP_MUL "*"
   ...
   */
   ...
   public:
      ...
      //         
      template <class T1, class T2 = CNotUsedTemplateField, class T3 = CNotUsedTemplateField, class T4 = CNotUsedTemplateField, class T5 = CNotUsedTemplateField, class T6 = CNotUsedTemplateField, class T7 = CNotUsedTemplateField, class T8 = CNotUsedTemplateField, class T9 = CNotUsedTemplateField, class T10 = CNotUsedTemplateField>
      inline CQuery& InsertInto(const CDatabaseTable& table,
                                const T1& field1,
                                const T2& field2 = T2(),
                                const T3& field3 = T3(),
                                const T4& field4 = T4(),
      ...
      //         
      template <class T1, class T2 = CNotUsedTemplateField, class T3 = CNotUsedTemplateField, class T4 = CNotUsedTemplateField, class T5 = CNotUsedTemplateField, class T6 = CNotUsedTemplateField, class T7 = CNotUsedTemplateField, class T8 = CNotUsedTemplateField, class T9 = CNotUsedTemplateField, class T10 = CNotUsedTemplateField>
      inline CQuery& InsertOrReplaceInto(const CDatabaseTable& table,
                                         const T1& field1,
                                         const T2& field2 = T2(),
                                         const T3& field3 = T3(),
                                         const T4& field4 = T4(),
      ...
      /// \return          A reference to itself to allow method chaining
      //     
      CQuery& DeleteFrom(const CDatabaseTable& table);
      ...
      /// \return             A reference to itself to allow method chaining
      //   
      CQuery& JoinLeft(const CDatabaseTable& tableName, const std::string& tableIdentifier = EMPTY_STR);
