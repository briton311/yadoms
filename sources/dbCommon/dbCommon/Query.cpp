...
namespace dbCommon
{
   ...
   CQuery& CQuery::DeleteFrom(const CDatabaseTable& table)
   {
   ...
   CQuery& CQuery::JoinLeft(const CDatabaseTable& tableName, const std::string& tableIdentifier)
   {
      std::ostringstream ss;
   ...
   CQuery& CQuery::AddTableColumn(const CDatabaseTable& tableName, const std::string& columnDefinition)
   {
