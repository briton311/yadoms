...
//
//
/// \note	This file MUST never be include (only in AsyncSerialPort.cpp)
///         This is due to PImpl design pattern, to limit boost::asio inclusion
//--------------------------------------------------------------
...
namespace shared { namespace communication {
   ...
   //--------------------------------------------------------------
   class YADOMS_SHARED_EXPORT CAsyncSerialPortPimpl : public IAsyncPort
   {  
   public:
      //--------------------------------------------------------------
      /// \brief	Constructor
