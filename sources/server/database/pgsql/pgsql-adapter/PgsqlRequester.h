...
{
   class CPgsqlRequester : public database::IDatabaseRequester
   {
   public:
      CPgsqlRequester();
      ...
      bool addTableColumn(const database::common::CDatabaseTable& tableName, const std::string& columnDef) override;
      void createIndex(const database::common::CDatabaseTable& tableName, const std::string& indexScript) override;
      void vacuum() override;
      boost::shared_ptr<database::ITableCreationScriptProvider> getTableCreationScriptProvider() override;
