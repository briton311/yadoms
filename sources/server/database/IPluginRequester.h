...
namespace database
{
   ...
   public:
      ...
      //--------------------------------------------------------------
      virtual int addInstance(const dbCommon::entities::CPlugin& newPlugin) = 0;
      ...
      //--------------------------------------------------------------
      virtual boost::shared_ptr<dbCommon::entities::CPlugin> getInstance(int pluginId) = 0;
      ...
      /// \throw           shared::exception::CEmptyResult if pluginId is unknown
      //--------------------------------------------------------------
      virtual boost::shared_ptr<dbCommon::entities::CPlugin> getSystemInstance() = 0;

      //--------------------------------------------------------------
      /// \brief           List all plugin instances
      /// \return          List of registered plugin instances
      //--------------------------------------------------------------
      virtual std::vector<boost::shared_ptr<dbCommon::entities::CPlugin>> getInstances() = 0;
      ...
      /// \throw           shared::exception::CEmptyResult if fails
      //--------------------------------------------------------------
      virtual void updateInstance(const dbCommon::entities::CPlugin& updatedPluginData) = 0;
