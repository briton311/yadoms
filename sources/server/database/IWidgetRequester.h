...
namespace database
{
   ...
   public:
      ...
      //--------------------------------------------------------------
      virtual int addWidget(const dbCommon::entities::CWidget& newWidget) = 0;
      ...
      //--------------------------------------------------------------
      virtual boost::shared_ptr<dbCommon::entities::CWidget> getWidget(int widgetId) = 0;

      //--------------------------------------------------------------
      /// \brief           List all widgets
      /// \return          List of registered widgets
      //--------------------------------------------------------------
      virtual std::vector<boost::shared_ptr<dbCommon::entities::CWidget>> getWidgets() = 0;
      ...
      /// \return          List of registered widgets
      //--------------------------------------------------------------
      virtual std::vector<boost::shared_ptr<dbCommon::entities::CWidget>> getWidgetsForPage(int pageId) = 0;
      ...
      /// \throw           shared::exception::CEmptyResult if fails
      //--------------------------------------------------------------
      virtual void updateWidget(const dbCommon::entities::CWidget& widget, bool createIfNotExists) = 0;
