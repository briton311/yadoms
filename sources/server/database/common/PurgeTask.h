...
namespace database
{
   namespace common
   {
      ...
      public:
         ...
         //--------------------------------------------------------------
         CPurgeTask(boost::shared_ptr<IAcquisitionRequester> acquisitionRequester, boost::shared_ptr<dbCommon::IDatabaseRequester> sqlRequester);
      ...
      private:
         ...
         /// \Brief		   Sql requester
         //--------------------------------------------------------------
         boost::shared_ptr<dbCommon::IDatabaseRequester> m_sqlRequester;
