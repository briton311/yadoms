...
namespace web
{
   namespace ws
   {
      CAcquisitionSummaryUpdateFrame::CAcquisitionSummaryUpdateFrame(const std::vector<boost::shared_ptr<dbCommon::entities::CAcquisitionSummary> >& acquisitionSummaries)
